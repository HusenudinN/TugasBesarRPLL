 ...
 * @author Husen
 */
public class RiwayatDataAdmin extends javax.swing.JFrame {

    private Statement stm;
    private Connection Con;
    private Object con;
    
    public RiwayatDataAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RIWAYAT DATA ADMIN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RiwayatDataAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/poliklinik","root","");
    ...
    private void tampilkandata() {
        ...
        tabelmapel.addColumn("NAMA ADMIN");
        tabelmapel.addColumn("PASSWORD");
        tabelmapel.addColumn("WAKTU");
        tabelmapel.addColumn("OLEH");
        try {
            open_db();
            String sql = "select * from hitori_admin";
            stm = (Statement) Con.createStatement();
